...
if __name__=="__main__":
    """ 
    python3 evaluation_comparison.py --data_percentage 0.1 --num_epochs 100 --batch_size 128 --simsiam_path 'models/simsiam_100_128.pth' --fedavg_simsiam_path 'models/simsiam_fedavg.pth'
